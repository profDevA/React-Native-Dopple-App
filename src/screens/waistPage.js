...
export default class WaistPage extends React.Component {
  ...
  componentDidMount = async()=>{
    ...
    this.setState({userId:userId,loading:true})
            ...
            await fetch('http://dopplle.net/Apimeasurement/measurement?measurementId= 2', {
                ...
                body:'UserID'+'='+userId+'&'+ 'MeasurementID'+'='+ '2'+'&'+ 'type'+'='+ 'read'
  ...
  handleFtInMinus=()=>{
    ...
    handleCmMinus=()=>{
        ...
        this.setState(prevState => ({ waist: prevState.waist -10 }))
    ...
    handleSave=()=>{
        ...
        const { userId,checkedFirst,waist,ftstate,cmstate,inchstate  } = this.state
        let measureUintId = 0
        if(ftstate===true)
        {
            measureUintId = 3
        ...
        // fetch('http://192.168.207.54:7002/Apimeasurement/measurement', {
            ...
            body:'checkedFirst'+'='+checkedFirst+'&'+ 'UserID'+'='+userId+'&'+ 'ValueMM'+'='+ waist+'&'+ 'MeasureUnitID'+'='+ measureUintId+'&'+ 'MeasurementID'+'='+2+'&'+ 'type'+'='+ 'Insertupdate'
          }).then((response) => response.json())
        ...
        <ScrollView style={{flex: 1}}>
            ...
            <View style={{marginLeft:10,marginRight:10,marginTop:30, flex: 1}}>
                ...
                <View style={{flexDirection:"row",justifyContent:"center"}}>
                    <View style={{width:screenWidth/2,marginLeft:20}}>
                        <Text 
                            style={{width:150,marginTop:30,color:"#6b6b6b",fontWeight:"bold",fontSize:22}}
                        >{SubHeading}
                        </Text>
                        <Text 
                            style={{width:170,marginTop:5,color:"#6b6b6b",fontWeight:"bold",fontSize:14}}
                        >{SubText}
                        </Text>
                    ...
                    <View style={{width:screenWidth/2}}>
                        <Image 
                            style={{width:170,height:screenHeight-120}}
