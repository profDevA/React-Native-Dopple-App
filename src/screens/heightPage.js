...
export default class HeightPage extends React.Component {
  ...
  handleFtInMinus=()=>{
       ...
       this.setState({height:tempCm*10})
    ...
    handleCmMinus=()=>{
        ...
        this.setState(prevState => ({ height: prevState.height - 10 }))
    ...
    handleSave=()=>{
        ...
        // fetch('http://192.168.207.54/Apimeasurement/measurement', {
            ...
            body:'checkedFirst'+'='+checkedFirst+'&'+ 'UserID'+'='+userId+'&'+ 'ValueMM'+'='+ height+'&'+ 'MeasureUnitID'+'='+ measureUintId+'&'+ 'MeasurementID'+'='+1+'&'+ 'type'+'='+ 'Insertupdate'
          }).then((response) => response.json())
            ...
            <View style={{marginLeft:10,marginRight:10,marginTop:30}}>
                ...
                <View style={{flexDirection:"row",justifyContent:"center"}}>
                    <View style={{width:screenWidth/2.1,marginLeft:20}}>
                        <Text 
                            style={{width:100,marginTop:40,color:"#6b6b6b",fontWeight:"bold",fontSize:22}}
                        >{SubHeading}
                        </Text>
                        <Text 
