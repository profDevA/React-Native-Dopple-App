...
export default class LegPage extends React.Component {
        ...
        //    fetch('http://192.168.207.54:7002/Apimeasurement/measurement?measurementId= 3', {
           await fetch('http://dopplle.net/Apimeasurement/measurement?measurementId= 3', {
                ...
                // fetch('http://192.168.207.54:7002/Apimeasurement/measurement', {
                    ...
                    body:'UserID'+'='+userId+'&'+ 'MeasurementID'+'='+ '3'+'&'+ 'type'+'='+ 'read'
  ...
  handleFtInMinus=()=>{
    ...
    handleCmMinus=()=>{
        ...
        this.setState(prevState => ({ leg: prevState.leg -10 }))
    ...
    handleSave=()=>{
        ...
        const { userId,checkedFirst,ftstate,cmstate,inchstate,leg  } = this.state
        let measureUintId = 0
        if(ftstate===true)
        {
            measureUintId = 3
        ...
        // fetch('http://192.168.207.54:7002/Apimeasurement/measurement', {
            ...
            body:'checkedFirst'+'='+checkedFirst+'&'+ 'UserID'+'='+userId+'&'+ 'ValueMM'+'='+ leg+'&'+ 'MeasureUnitID'+'='+ measureUintId+'&'+ 'MeasurementID'+'='+3+'&'+ 'type'+'='+ 'Insertupdate'
          }).then((response) => response.json())
                ...
                {!loading && (
                 <View style={{marginLeft:10,marginRight:10,marginTop:30}}>
                     ...
                     <View style={{flexDirection:"row",justifyContent:"center"}}>
                         <View style={{width:screenWidth/2.1,marginLeft:15}}>
                             <Text 
                                 style={{width:150,marginTop:50,color:"#6b6b6b",fontWeight:"bold",fontSize:22}}
                             >{SubHeading}
                             </Text>
                             <Text 
                        ...
                        {inchstate &&(
                         ...
                         <View style={{width:screenWidth/2.1, marginRight:15}}>
                             <Image 
